...
import com.nirbhay.autoplayvideosample.interfaces.ResultObject;
import com.nirbhay.autoplayvideosample.interfaces.VideoInterface;
 ...
 */
public class UploadRecordingActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks{
    ...
    ArrayList<String>videols=new ArrayList<String>();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(resultCode == Activity.RESULT_OK && requestCode == REQUEST_VIDEO_CAPTURE){
            uri = data.getData();
            if(EasyPermissions.hasPermissions(UploadRecordingActivity.this, android.Manifest.permission.READ_EXTERNAL_STORAGE)){
                displayRecordedVideo.setVideoURI(uri);
                displayRecordedVideo.start();

                pathToStoredVideo = getRealPathFromURIPath(uri, UploadRecordingActivity.this);
                Log.d(TAG, "Recorded Video Path " + pathToStoredVideo);
                //Store the video to your server
                uploadVideoToServer(pathToStoredVideo);

            }else{
                EasyPermissions.requestPermissions(UploadRecordingActivity.this, getString(R.string.read_file), READ_REQUEST_CODE, Manifest.permission.READ_EXTERNAL_STORAGE);
            }
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, UploadRecordingActivity.this);
    }
    @Override
        ...
        serverCom.enqueue(new Callback<ResultObject>() {
            ...
            public void onResponse(Call<ResultObject> call, Response<ResultObject> response) {
                ...
                if(!TextUtils.isEmpty(result.getSuccess())){
                    Toast.makeText(UploadRecordingActivity.this, "Result " + result.getSuccess(), Toast.LENGTH_LONG).show();
